...
export default function Footer() {
  return (
    <footer className="w-full h-[355px] flex-shrink-0 bg-darkbrown mt-10 flex flex-col items-center">
      ...
      <p className="text-background text-center font-montserrat text-[15px] font-semibold leading-normal mt-[7px]">Roots Street Food © {new Date().getFullYear()}</p>
      <p className="text-background text-center font-montserrat text-[12px] font-semibold leading-normal mt-[4px]">Website by <a href="https://rikkejuliane.netlify.app/">Rikke Juliane</a></p>
    </footer>
  );
}
